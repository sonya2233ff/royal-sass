...
- **No Frills #3660:** `NoFrillsConnector` / PCX BFF (`NOFRILLS_SEARCH_URL`, `NOFRILLS_API_KEY`). Datacenter IPs often 401. Flipp only if `NOFRILLS_ALLOW_FLIPP_FALLBACK=1` (not shelf).
